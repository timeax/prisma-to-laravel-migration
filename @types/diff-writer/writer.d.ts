 ...
 */
export declare function writeWithMerge(filePath: string, theirs: string, type: "migrator" | "model" | "ts", overwrite?: boolean, currentPath?: string | null, removeOld?: boolean): Promise<void>;
